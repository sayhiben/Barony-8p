...
static void changeLevel() {
	...
	LevelLoadSync::beginClientLevelChangeFromPacket(net_packet);
...
#endif
	LevelLoadSync::validateClientLoadedMap(map, loadResult.entityChecksumValid, loadResult.entityChecksum);
...
static std::unordered_map<Uint32, void(*)()> clientPacketHandlers = {
	...
	{ 'MSNP', []() {
		LevelLoadSync::handleMapSnapshotChunkPacket();
	} },
...
static std::unordered_map<Uint32, void(*)()> serverPacketHandlers = {
	...
	{'MSRQ', []() {
		LevelLoadSync::handleMapSnapshotRequestPacket();
	}},
